...
// STEP 0: Look over the code from start to finish
//
...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      // SAMPLE html = insertProperty(html, "name", name);
      var homeHtmlToInsertIntoMainPage =
        insertProperty(
          homeHtml,
      ...
      // of how to do that.
      // SAMPLE insertHtml("#main-content", categoriesViewHtml);
...
dc.loadAbout = function () {
  ...
  $ajaxUtils.sendGetRequest(
    aboutHtml,
    buildRandomRatingAbout,
    false
    );
};

function buildRandomRatingAbout(homeHtml) {
  $ajaxUtils.sendGetRequest(
    aboutHtml,
    function (homeHtml) {
      ...
      for (i = 1; i < 6; i++) {
        if (rating >= i) {
            ratingSymbol = "fa fa-star";
          } else {
            ratingSymbol = "fa fa-star-o";
          }
